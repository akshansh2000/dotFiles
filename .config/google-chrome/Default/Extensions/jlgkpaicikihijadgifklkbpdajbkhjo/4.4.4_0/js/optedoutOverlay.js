...
var _Wrapper = __webpack_require__(333);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

if (document.getElementById('crxMouseOptedoutOverlay') === null) {
    var newElement = document.createElement('div');
    newElement.id = "crxMouseOptedoutOverlay";
    document.body.appendChild(newElement);

    var fontElement = document.createElement('link');
    fontElement.href = "https://fonts.googleapis.com/css?family=Barlow:400,600,700";
    fontElement.rel = 'stylesheet';
    document.head.appendChild(fontElement);

    (0, _reactDom.render)(_react2.default.createElement(_Wrapper.OptedoutOverlayWrapper, null), document.querySelector('#crxMouseOptedoutOverlay'));
}
...
exports.OptedoutOverlayWrapper = undefined;
...
var OptedoutOverlayWrapper = exports.OptedoutOverlayWrapper = function (_React$Component) {
    _inherits(OptedoutOverlayWrapper, _React$Component);

    function OptedoutOverlayWrapper(props) {
        _classCallCheck(this, OptedoutOverlayWrapper);

        var _this = _possibleConstructorReturn(this, (OptedoutOverlayWrapper.__proto__ || Object.getPrototypeOf(OptedoutOverlayWrapper)).call(this, props));

        _this.state = {
            view: 'overlay'
        };
        _this.unmountMe = _this.unmountMe.bind(_this);
        return _this;
    }

    _createClass(OptedoutOverlayWrapper, [{
        key: 'unmountMe',
        value: function unmountMe() {
            var _this2 = this;
        ...
        value: function render() {
            ...
            return view === 'overlay' ? React.createElement(_Overlay.OptedoutOverlay, { unmountMe: this.unmountMe }) : null;
        }
    }]);

    return OptedoutOverlayWrapper;
}(React.Component);
...
exports.OptedoutOverlay = undefined;
...
var OptedoutOverlay = exports.OptedoutOverlay = function (_React$Component) {
    _inherits(OptedoutOverlay, _React$Component);

    function OptedoutOverlay(props) {
        _classCallCheck(this, OptedoutOverlay);

        var _this = _possibleConstructorReturn(this, (OptedoutOverlay.__proto__ || Object.getPrototypeOf(OptedoutOverlay)).call(this, props));

        _this.optInBack = _this.optInBack.bind(_this);
        _this.optOutBack = _this.optOutBack.bind(_this);
        _this.opacityIn = _this.opacityIn.bind(_this);
        _this.opacityOut = _this.opacityOut.bind(_this);
        _this.ppClick = _this.ppClick.bind(_this);
        _this.isOptionsPage = location.href.includes(chrome.extension.getURL('options.html'));

        return _this;
    }

    _createClass(OptedoutOverlay, [{
        key: 'optInBack',
        value: function optInBack() {
            var unmountMe = this.props.unmountMe;

            chrome.runtime.sendMessage({ type: "toggleOptedOut", optedout: false });
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: this.isOptionsPage ? "General" : "Stand Alone", gaAction: "Make a selection", gaLabel: "Agree" });
        ...
        value: function optOutBack() {
            ...
            chrome.runtime.sendMessage({ type: "toggleOptedOut", optedout: true, preventReload: isOptionsPage ? true : false });
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: this.isOptionsPage ? "General" : "Stand Alone", gaAction: "Make a selection", gaLabel: "Disagree" });
            chrome.runtime.sendMessage({ type: "madeASelectionOptin" });
            chrome.runtime.sendMessage({ type: "openOnboarding" });
            this.opacityOut();
            unmountMe();
        ...
        key: 'opacityIn',
        value: function opacityIn() {
            document.getElementsByClassName('overlay')[0].classList.add('opacityIn');
        }
    }, {
        key: 'opacityOut',
        value: function opacityOut() {
            document.getElementsByClassName('overlay')[0].classList.remove('opacityIn');
            document.getElementsByClassName('overlay')[0].classList.add('opacityOut');
            document.getElementsByClassName('overlay')[0].style.opacity = '0';
        }
    }, {
        key: 'ppClick',
        value: function ppClick() {
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: this.isOptionsPage ? "General" : "Stand Alone", gaAction: "Make a selection", gaLabel: "PP Link" });
        }
    }, {
        key: 'componentDidMount',
        value: function componentDidMount() {
            this.opacityIn();
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: this.isOptionsPage ? "General" : "Stand Alone", gaAction: "Make a selection", gaLabel: "Shown" });
        }
    }, {
        key: 'render',
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'overlay-container-wrapperlogo' },
                        React.createElement('img', { src: chrome.extension.getURL("/image/Princess_in_distress.gif"), className: 'overlay-container-wrapperlogo-logo' })
                    ),
                    React.createElement(
                        'div',
                        { className: 'overlay-container-title' },
                        'Please make a selection'
                    ),
                    React.createElement(
                        'div',
                        { className: 'overlay-container-subtitle' },
                        'CRX Mouse wants to provide you with the best experience possible. To do this, we need access to visited URLs. Read more about it in our ',
                        React.createElement(
                            'a',
                            { href: 'https://crxmouse.com/privacy/', target: '_blank', onClick: this.ppClick },
                            'Privacy Policy'
                        ),
                        '. Click \'Agree\' to enable.'
                    ),
                    React.createElement(
                        'div',
                        { className: 'overlay-container-ctas' },
                        React.createElement(
                            'div',
                            { className: 'overlay-container-ctas-disagree', onClick: this.optOutBack },
                            'Disagree'
                        ),
                        React.createElement(
                            'div',
                            { className: 'overlay-container-ctas-agree', onClick: this.optInBack },
                            'Agree'
                        )
                    )
                )
...
// module
exports.push([module.i, ".overlay {\n  background-color: rgba(0, 0, 0, 0.5);\n  height: 100vh;\n  width: 100vw;\n  position: fixed;\n  top: 0;\n  left: 0;\n  z-index: 2147483646;\n  font-family: Barlow; }\n  .overlay-container {\n    height: 404px;\n    width: 460px;\n    border-radius: 4px;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n        -ms-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    z-index: 2147483647;\n    position: fixed;\n    left: 50%;\n    top: 50%;\n    -webkit-transform: translate(-50%, -50%);\n            transform: translate(-50%, -50%);\n    background-color: #ffffff; }\n    .overlay-container-wrapperlogo {\n      width: 100%;\n      background: #000000;\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-pack: center;\n          -ms-flex-pack: center;\n              justify-content: center;\n      border-top-left-radius: 4px;\n      border-top-right-radius: 4px; }\n      .overlay-container-wrapperlogo-logo {\n        width: 155px;\n        height: 150px;\n        margin-top: 10px;\n        margin-right: 55px; }\n    .overlay-container-title {\n      margin-top: 25px;\n      font-size: 24px;\n      font-weight: bold;\n      line-height: 1.5;\n      text-align: center;\n      color: #5d1e7a; }\n    .overlay-container-subtitle {\n      margin-top: 10px;\n      width: 416px;\n      font-size: 14px;\n      line-height: 1.30;\n      text-align: center;\n      letter-spacing: 0.3px;\n      color: #292929; }\n      .overlay-container-subtitle a:link {\n        color: #292929;\n        text-decoration: underline; }\n      .overlay-container-subtitle a:visited {\n        color: #292929;\n        text-decoration: underline; }\n      .overlay-container-subtitle a:hover {\n        color: #292929;\n        text-decoration: underline; }\n      .overlay-container-subtitle a:active {\n        color: #292929;\n        text-decoration: underline; }\n    .overlay-container-ctas {\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      -webkit-box-orient: horizontal;\n      -webkit-box-direction: normal;\n          -ms-flex-direction: row;\n              flex-direction: row;\n      -webkit-box-pack: center;\n          -ms-flex-pack: center;\n              justify-content: center; }\n      .overlay-container-ctas-agree {\n        margin-top: 31px;\n        width: 111px;\n        height: 40px;\n        border-radius: 5px;\n        background-color: #5d1e7a;\n        text-align: center;\n        line-height: 40px;\n        cursor: pointer;\n        font-size: 18px;\n        font-weight: 600;\n        color: #ffffff; }\n        .overlay-container-ctas-agree:hover {\n          background-color: #6d3487; }\n      .overlay-container-ctas-disagree {\n        margin-top: 31px;\n        width: 111px;\n        height: 40px;\n        border-radius: 5px;\n        background-color: #ffffff;\n        text-align: center;\n        line-height: 40px;\n        cursor: pointer;\n        font-size: 18px;\n        font-weight: 600;\n        color: #5d1e7a;\n        border: solid 1px #5d1e7a;\n        margin-right: 17px;\n        -webkit-box-sizing: border-box;\n                box-sizing: border-box; }\n        .overlay-container-ctas-disagree:hover {\n          background-color: #efefef; }\n\n.opacityIn {\n  -webkit-animation: opacityIn 1s linear;\n          animation: opacityIn 1s linear; }\n\n.opacityOut {\n  -webkit-animation: opacityOut 1s linear;\n          animation: opacityOut 1s linear; }\n\n@-webkit-keyframes opacityIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n@keyframes opacityIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n@-webkit-keyframes opacityOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n@keyframes opacityOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n", ""]);
