  ...
  if (!window.netflixPartyLoaded) {
	...
	var checkTestExtension = function() {
		if(jQuery(".ltr-fntwn3").length > 0) {
			alert("You are using an experimental Netflix video player which Netflix Party does not support.\n\nPlease switch to the standard player by turning your test participation settings off at Netflix.com/DoNotTest, refresh the page, and try again to continue using Netflix Party.");
